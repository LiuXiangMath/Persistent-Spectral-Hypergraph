...
def run_for_PDBbind_2016():
    ...
    # create hypergraph
    simplices_to_file(0,4057,10,0)      
    
    # compute_spectral_information
    eigenvalue_to_file_complex(0,4057,10,7,7,0.1)
    eigenvalue_to_file_ligand(0,4057,10,7,0.1)
    
    # feature generation
    train_feature_to_file(0,3772,10,7,7,0.1)
    test_feature_to_file(0,285,10,7,7,0.1)
    train_feature_to_file_combined(0,3772,10,7,7,0.1)
    test_feature_to_file_combined(0,285,10,7,7,0.1)
